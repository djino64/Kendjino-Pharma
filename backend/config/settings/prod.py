"""Production settings for Render with PostgreSQL."""
import os
import dj_database_url
from decouple import config

# N'importe PAS base.py pour éviter tout conflit
# from .base import *  ← COMMENTE OU SUPPRIME CETTE LIGNE

# Configuration de base (copie depuis base.py mais sans DATABASES)
...
ROOT_URLCONF = 'config.urls'  # ← TRÈS IMPORTANT !
